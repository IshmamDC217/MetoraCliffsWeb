          ...
          <div className='flex items-center justify-between w-[300px]'>
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex gap-4 items-center font-medium'>
                ...
                <a className='text-[#ffffff]' href="https://instagram.com/metoracliffsmusic" target="_blank">Instagram</a>
              </div>

              <div className='flex gap-4 items-center font-medium'>
                <AiFillYoutube className='text-[#c4302b] text-[22px]' />
                <a className='text-[#ffffff]' href="https://youtube.com/@metoracliffs5994" target="_blank">Youtube</a>
              </div>

              <div className='flex gap-4 items-center font-medium'>
                <AiFillFacebook className='text-[#3b5998] text-[22px]' />
                <a className='text-[#ffffff]' href="https://facebook.com/metoracliffs" target="_blank">Facebook</a>
              </div>

              <div className='flex gap-4 items-center font-medium'>
                <FaTiktok className='text-[#00f2ea] text-[22px]' />
                <a className='text-[#ffffff]' href="https://tiktok.com/@metoracliffs" target="_blank">TikTok</a>
              </div>

              <div className='flex gap-4 items-center font-medium'>
                <FaSpotify className='text-[#1db954] text-[22px]' />
                <a className='text-[#ffffff]' href="https://open.spotify.com/artist/7L8GCBu7rpT4nWglH7d0X6" target="_blank">Spotify</a>
              </div>
